...
# We must explicitly allow the Authorization header from your frontend's origin
CORS(app, resources={
    r"/*": {
        "origins": "http://localhost:3000", # Allow your frontend
        "supports_credentials": True,
        "allow_headers": ["Content-Type", "Authorization"] # Allow this header
    }
})
# ------------------------------------
...
@jwt_required() 
def upload_file():
    return jsonify({'error': 'File upload is no longer supported. Please use manual entry.'}), 405
